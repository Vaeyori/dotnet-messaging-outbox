...
namespace Vaeyori.Messaging.Outbox
{
    ...
    public interface IMessageStore
    {
        ...
        Task<IEnumerable<Message>> ReadAsync(CancellationToken cancellationToken = default);
        ValueTask RemoveAsync(Message message, CancellationToken cancellationToken = default);
